function createMap(MovieTheaters) {
    ...
    var map = L.map("map-id", {
        center: [41.48, -81.80], // center = zipgeocode
        zoom: 12,
...
function createMarkers(response) {
    ...
    // Pull the Movie theaters property off of response
    var theaters = response.Theaters; //if gabbed from /scrape
    //var theaters = response;
